...
const ReviewModal: React.FC<ReviewModalProps> = ({ isOpen, onClose, onConfirm, isLoading, users, selectedUserId, onChange, error }) => {
        ...
        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
          <div>
            ...
            <div className="mt-3 text-center sm:mt-5">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">Please select your name to mark this report as reviewed.</p>
                <div className="mt-4">
                  <label htmlFor="reviewerUser" className="block text-sm font-medium text-gray-700">Your Name</label>
                  <select
                    id="reviewerUser"
                    name="reviewerUser"
          ...
          <div className="mt-5 sm:mt-6 flex justify-center space-x-3">
            ...
            >
              {isLoading ? 'Processing...' : 'Yes, Mark as Reviewed'}
            </button>
            <button
              type="button"
